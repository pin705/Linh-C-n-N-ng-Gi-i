...
export const BUILDINGS: Record<string, Building> = {
  ...
  wood_yard: {
    ...
    levels: [
      { level: 1, cost: { linhMoc: 50 }, buildTime: 20, prerequisites: [], effects: { production_linhMoc: 60 }, description: 'Sản lượng 60 Linh Mộc/phút.' },
      { level: 2, cost: { linhMoc: 120 }, buildTime: 45, prerequisites: [{ buildingId: 'main_hall', level: 1 }], effects: { production_linhMoc: 108 }, description: 'Sản lượng 108 Linh Mộc/phút.' },
      { level: 3, cost: { linhMoc: 280, hanNgoc: 50 }, buildTime: 120, prerequisites: [{ buildingId: 'main_hall', level: 2 }], effects: { production_linhMoc: 180 }, description: 'Sản lượng 180 Linh Mộc/phút.' },
      { level: 4, cost: { linhMoc: 650, hanNgoc: 150 }, buildTime: 300, prerequisites: [{ buildingId: 'main_hall', level: 3 }], effects: { production_linhMoc: 290 }, description: 'Sản lượng 290 Linh Mộc/phút.' },
      { level: 5, cost: { linhMoc: 1500, hanNgoc: 400 }, buildTime: 900, prerequisites: [{ buildingId: 'main_hall', level: 4 }], effects: { production_linhMoc: 450 }, description: 'Sản lượng 450 Linh Mộc/phút.' }
    ]
  },
  stone_mine: {
    ...
    levels: [
      { level: 1, cost: { linhMoc: 80 }, buildTime: 30, prerequisites: [], effects: { production_hanNgoc: 40 }, description: 'Sản lượng 40 Hàn Ngọc/phút.' },
      { level: 2, cost: { linhMoc: 200 }, buildTime: 60, prerequisites: [{ buildingId: 'main_hall', level: 1 }], effects: { production_hanNgoc: 75 }, description: 'Sản lượng 75 Hàn Ngọc/phút.' },
      { level: 3, cost: { linhMoc: 500, hanNgoc: 100 }, buildTime: 150, prerequisites: [{ buildingId: 'main_hall', level: 2 }], effects: { production_hanNgoc: 130 }, description: 'Sản lượng 130 Hàn Ngọc/phút.' },
      { level: 4, cost: { linhMoc: 1200, hanNgoc: 300 }, buildTime: 400, prerequisites: [{ buildingId: 'main_hall', level: 3 }], effects: { production_hanNgoc: 220 }, description: 'Sản lượng 220 Hàn Ngọc/phút.' },
      { level: 5, cost: { linhMoc: 2800, hanNgoc: 800 }, buildTime: 1200, prerequisites: [{ buildingId: 'main_hall', level: 4 }], effects: { production_hanNgoc: 360 }, description: 'Sản lượng 360 Hàn Ngọc/phút.' }
    ]
  },
  alchemy_lab: {
...
// server/configs/effects.config.ts
